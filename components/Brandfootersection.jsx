...
//               />
//               <p
//                 className="text-[10px] text-white/50 mt-1 uppercase tracking-widest"
...
//             {/* Centre — address */}
//             <div className="flex flex-col gap-1 text-[10px] text-white/60" style={{ fontWeight: 100, maxWidth: "260px" }}>
//               <p className="text-white/40 uppercase tracking-widest text-[9px] mb-1">Registered Office</p>
...
//             {/* Right — contact */}
//             <div className="flex flex-col gap-1 text-[10px] text-white/60 text-right" style={{ fontWeight: 100 }}>
//               <p className="text-white/40 uppercase tracking-widest text-[9px] mb-1">Contact</p>
...
//             <div className="flex flex-wrap gap-x-6 gap-y-2 text-[10px] text-white/50" style={{ fontWeight: 100 }}>
//               <a href="#" className="hover:text-white transition-colors">Terms of Use</a>
//               <a href="#" className="hover:text-white transition-colors">Privacy Policy</a>
//               <a href="#" className="hover:text-white transition-colors">Cookies Policy</a>
//               <a href="#" className="hover:text-white transition-colors">Risk Disclosures</a>
//             </div>
//             <p className="text-[10px] text-white/30" style={{ fontWeight: 100 }}>
