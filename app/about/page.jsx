      ...
      <main className="bg-black text-white">
        ...
        <section ref={heroRef} className="relative min-h-screen flex items-end overflow-hidden px-6 pb-16 md:px-20 md:pb-24">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            >
              About<br />
              <em style={{ fontStyle:"italic", color:"rgb(255, 255, 255)" }}>Savoy.</em>
            </h1>

            <div style={fadeUp(heroInView,"0.3s")} className="mt-8">
              <span className="block w-10 h-px bg-white mb-6" />
              <p className="text-white/40 max-w-lg" style={{ fontFamily:sans, fontSize:"0.85rem", fontWeight:300, lineHeight:1.8 }}>
        ...
        <section ref={missionRef} className="relative py-24 px-6 md:px-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl md:ml-[16%]">
            ...
            <p
              style={{ ...fadeUp(missionInView,"0.15s"), fontFamily:serif, fontSize:"clamp(1.5rem,2.5vw,2.4rem)", fontWeight:300, lineHeight:1.35 }}
              className="text-white"
            >
            ...
            <p
              style={{ ...fadeUp(missionInView,"0.28s"), fontFamily:sans, fontSize:"0.85rem", fontWeight:300, lineHeight:1.8 }}
            ...
            {values.map((v, i) => (
              ...
              >
                <div style={{ fontFamily:serif, fontSize:"0.85rem", fontWeight:300, letterSpacing:"0.1em" }}
                     className="text-white/25 flex-shrink-0 w-10 pt-0.5">
                  {v.n}
                </div>
                <div>
                  ...
                  <div style={{ fontFamily:sans, fontSize:"0.82rem", fontWeight:300, lineHeight:1.7 }}
                       className="text-white/40">{v.body}</div>
                </div>
              </div>
            ))}
          </div>
            ...
            {milestones.map((m, i) => (
              ...
              >
                <div className="flex-shrink-0 pt-1">
                  <span
                    className="block border border-white/18 px-3 py-1 text-white/35 uppercase"
                    style={{ fontFamily:sans, fontSize:"0.6rem", letterSpacing:"0.18em" }}
                  >
                    {m.year}
                  </span>
                </div>
                <p style={{ fontFamily:sans, fontSize:"0.83rem", fontWeight:300, lineHeight:1.75 }}
        ...
        <section ref={locationRef} className="py-24 px-6 md:px-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              >
                Nassau,<br />
                <em style={{ fontStyle:"italic", color:"rgba(255,255,255,0.35)" }}>The Bahamas.</em>
              </h2>

              <p
                style={{ ...fadeUp(locationInView,"0.25s"), fontFamily:sans, fontSize:"0.83rem", fontWeight:300, lineHeight:1.8 }}
                className="text-white/40 mt-7 max-w-md"
              >
              ...
              <div style={fadeUp(locationInView,"0.38s")} className="mt-10 flex flex-col gap-5">
                {[
                  ...
                  <div key={k} className="flex gap-6 items-start border-l border-white/10 pl-5">
                    <span style={{ fontFamily:sans, fontSize:"0.62rem", letterSpacing:"0.15em" }}
                          className="text-white/28 uppercase flex-shrink-0 w-20">{k}</span>
                    <span style={{ fontFamily:serif, fontSize:"0.95rem", fontWeight:300 }}
                          className="text-white/65">{v}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 px-6 md:px-20 flex flex-col items-center text-center">
          ...
          <span className="block w-10 h-px bg-white/20 mt-8" />
          <p style={{ fontFamily:sans, fontSize:"0.62rem", letterSpacing:"0.2em" }} className="uppercase text-white/22 mt-4">
            Savoy Bank &amp; Trust
          </p>
        </section>
        ...
        <section ref={ctaRef} className="py-24 px-6 md:px-20 flex flex-col items-center text-center">
          ...
          <p
            ...
            className="text-white/38 mt-5 max-w-md"
          >
          ...
          <div style={fadeUp(ctaInView,"0.35s")} className="mt-10 flex flex-col sm:flex-row gap-4 items-center">
            <a
              ...
              className="inline-flex items-center gap-3 uppercase text-white no-underline border border-white/20 px-8 py-3 transition-all duration-300 hover:border-white hover:bg-white/5"
            >
              Email Us
            ...
            <a
              href="/contact-us"
              style={{ fontFamily:sans, fontSize:"0.72rem", letterSpacing:"0.18em" }}
              className="inline-flex items-center gap-2 uppercase text-white/38 no-underline transition-colors duration-300 hover:text-white"
            >
              Contact Page
